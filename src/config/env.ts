...
const env = {
  // API Configuration
  API_URL: process.env.NEXT_PUBLIC_API_URL || 'https://testapi.bursalotuspsikolog.com',
  SOCKET_URL: process.env.NEXT_PUBLIC_SOCKET_URL || 'https://testapi.bursalotuspsikolog.com',
